...
def get_llm_feedback(text="",model="deepseek-r1:14b"):
    content = text
    messages = []
...
'''
    ...
    response = get_llm_feedback(text=prompt, model="deepseek-r1:14b")
...
def agent_check_move_to_next_explanation(question, explanation, scale, check_messages, model="deepseek-r1:14b"):
    conversation = ""
    messages = []
    start_time = time.time()
    for h in check_messages:
